def main():
  ...
  while len(galaxies) > 0:
    ...
    for other_galaxy in galaxies:
      distance = abs(this_galaxy["x"] - other_galaxy["x"])
      distance += abs(this_galaxy["y"] - other_galaxy["y"])
      distances_expanded_one += distance

  expansion_diff = distances_expanded_one - distances_normal
  distances_expanded_million = distances_normal + expansion_diff*999999
  print(distances_expanded_million)
